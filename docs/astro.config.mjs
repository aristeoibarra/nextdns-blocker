...
export default defineConfig({
	integrations: [
		starlight({
			...
			social: [
				{ icon: 'github', label: 'GitHub', href: 'https://github.com/aristeoibarra/nextdns-blocker' },
			],
			editLink: {
				baseUrl: 'https://github.com/aristeoibarra/nextdns-blocker/edit/main/docs/',
			},
			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: 'allow / disallow', slug: 'commands/allowlist' },
				...
				},
				{
					...
					items: [
						...
						{ label: 'Environment Variables', slug: 'configuration/env-variables' },
						{ label: 'config.json Structure', slug: 'configuration/config-json' },
						...
						{ label: 'Unblock Delay', slug: 'configuration/unblock-delay' },
				...
				},
				{
					...
					items: [
						...
						{ label: 'Pending Actions', slug: 'features/pending-actions' },
						{ label: 'Discord Notifications', slug: 'features/notifications' },
						{ label: 'Shell Completion', slug: 'features/shell-completion' },
				...
				},
				{
					...
					items: [
						...
						{ label: 'Productivity Setup', slug: 'guides/productivity' },
						{ label: 'Parental Control', slug: 'guides/parental-control' },
						{ label: 'Study Mode', slug: 'guides/study-mode' },
						{ label: 'Gaming Schedule', slug: 'guides/gaming-schedule' },
				...
				},
				{
					...
					items: [
						...
						{ label: 'API & Rate Limiting', slug: 'reference/api-limits' },
					],
				},
				{
					label: 'FAQ',
